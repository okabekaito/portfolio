export const DeliverablesList = [
    ...
    },
    {
        ...
        title:"筋トレ管理アプリ",
        content:"Udemy で React を学んだため、練習＆自分用アプリとしてバックエンドに Laravel、フロントエンドに React を使って SPA 化して開発しました。",
        TechnologyName:"React,Laravel",
        code:"https://github.com/okabekaito/MuscleTrainingApp.git"
    },
    {
        image:"images/IMG5.png",
        title:"これから愚痴ります",
        content:"人間関係や仕事のこと、心に抱え込んでいることを吐き出すためのアプリケーションです。いいねで共感を多く得た投稿はランキングのページに載ります",
        TechnologyName:"Laravel",
        code:"https://github.com/okabekaito/TweetApp.git"
    },
    {
        image:"images/IMG_0338.jpg",
